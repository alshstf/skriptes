...
- **Язык оригинала и переводчик** — из fb2 (`<src-lang>`, translator) → Wikidata («язык произведения», только однозначные ответы) для переводов, где fb2 оригинала не дал; на карточке — строка «Перевод с французского — …»
