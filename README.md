...
- **Работы и издания**: переводы/переиздания одной книги группируются в логическую «работу» (автоматически + ручные merge/split у админа) — в поиске и списках нет дублей, на карточке видны все издания; ошибочно слитые работы админ разбирает массово (regroup-API с прогрессом и отменой в админке)
...
#    SKRIPTES_VERSION=1.7.1               # тег релиза
