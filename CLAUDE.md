...
Текущая верхняя — `0014_book_cover_lookups` (per-source учёт внешнего
дозаполнения обложек, зеркало `0013_book_year_lookups` для года). Backend хранит
