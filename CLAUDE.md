...
трогают. Текущая версия — **0.9.2** (стабильный; модель «книга → издания»:
works, группировка, схлопывание поиска/каталога, секция «Издания»; 0.9.2 —
якорное издание (авто-защита от выноса при split) + мини-обложки изданий + фикс
серии после split + инфо в split-диалоге; 0.9.1 — развязка Tier-1/1.5 от Tier-2 в
группировке; 0.9.0 — Tier-1.5 + ручной merge/split и подсказки на карточках;
0.8.0 — works-индекс Meili + маршрут `/works/{id}`);
