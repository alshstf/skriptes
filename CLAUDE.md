...
Текущая верхняя — `0030_normalize_src_lang` (канонизация `books.src_lang` lower+trim+срез
...
трогают. Текущая версия — **1.7.2** — **честная группировка на грязных данных + пересбор
